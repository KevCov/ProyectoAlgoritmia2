...
public class ConsultaProd extends JFrame {
	...
	public ConsultaProd() {
		...
		}
		{
			...
			btnConsultar.setIcon(new ImageIcon(ConsultaProd.class.getResource("/imagenes/icon-buscar-cli.png")));
			btnConsultar.setBackground(Color.WHITE);
			btnConsultar.setBounds(100, 235, 45, 40);
		...
		}
		{
			...
			btnCerrar.setIcon(new ImageIcon(ConsultaProd.class.getResource("/imagenes/icon-exit.png")));
