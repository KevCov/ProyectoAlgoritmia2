...
public class ConsultaVen extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultaVen frame = new ConsultaVen();
	...
	public ConsultaVen() {
		...
		}
		{
			...
			btnConsultar.setIcon(new ImageIcon(ConsultaVen.class.getResource("/imagenes/icon-buscar-cli.png")));
			btnConsultar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					actionPerformedBtnConsultar(e);
				}
			});
			btnConsultar.setBounds(100, 405, 45, 40);
			contentPane.add(btnConsultar);
		}
		{
			btnCerrar = new JButton("");
			btnCerrar.setBackground(Color.WHITE);
			btnCerrar.setIcon(new ImageIcon(ConsultaVen.class.getResource("/imagenes/icon-exit.png")));
