...
public class ModificacionVen extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModificacionVen frame = new ModificacionVen();
	...
	public ModificacionVen() {
		...
		}
		{
			...
			btnConsultar.setIcon(new ImageIcon(ModificacionVen.class.getResource("/imagenes/icon-buscar-cli.png")));
		...
		}
		{
			...
			btnCerrar.setIcon(new ImageIcon(ModificacionVen.class.getResource("/imagenes/icon-exit.png")));
		...
		}
		{
			...
			btnModificar.setIcon(new ImageIcon(ModificacionVen.class.getResource("/imagenes/icon-modifi.png")));
			btnModificar.setBounds(100, 405, 45, 40);
		...
		}
		{
			...
			cbxCodVen.setBounds(150, 50, 260, 25);
	...
	private void consultar() {
		...
		txtApeVen.setEditable(true);
		txtTelfVen.setText("" + vendedor.getTelefono());
		txtTelfVen.setEditable(true);
		txtDniVen.setText("" + vendedor.getDni());
		txtDniVen.setEditable(true);
	...
	private void modificar() {
		...
		if (c == 0) {
			Vendedor vendedor = modify(cbxCodVen.getSelectedItem());
			vendedor.setCategoria(Integer.parseInt(txtCategoria.getText()));
			vendedor.setNombres(txtNomVen.getText());
			vendedor.setApellidos(txtApeVen.getText());
			vendedor.setTelefono(txtTelfVen.getText());
			vendedor.setDni(txtDniVen.getText());
			cerrar();
		}
	}
	...
	private Vendedor modify(Object cod) {
		return ArregloVendedor.obtener(ArregloVendedor.encontrar(Integer.parseInt(String.valueOf(cod))));
	}
